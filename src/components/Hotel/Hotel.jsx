...
const Hotel = ({ offerId, offers }) => {
  let card = offers.find((elem) => elem.id == offerId);
          ...
          <div className="property__container container">
            <div className="property__wrapper">
              <div className="property__mark">
                <span>{card.is_premium ? `Premium` : `Normal`}</span>
              </div>
